...
if True:
    ...
    hol1.name = 'hol1'
    hol1.addSampleSlotPosition( Sample('Sample_O1', **md),1, 10,'WAXS', incident_angles=[0.05, 0.08, 0.1, 0.12, 0.15], thickness =0.7)
    hol1.addSampleSlotPosition( Sample('Sample_O2', **md),2, 26,'WAXS', incident_angles=[0.05, 0.08, 0.1, 0.12, 0.15], thickness =0.7)
    hol1.addSampleSlotPosition( Sample('Sample_O3', **md),3, 44,'WAXS', incident_angles=[0.05, 0.08, 0.1, 0.12, 0.15], thickness =0.7)
    hol1.addSampleSlotPosition( Sample('Sample_O4', **md),4, 59,'WAXS', incident_angles=[0.05, 0.08, 0.1, 0.12, 0.15], thickness =0.7)
    hol1.addSampleSlotPosition( Sample('Sample_O5', **md),5, 76,'WAXS', incident_angles=[0.05, 0.08, 0.1, 0.12, 0.15], thickness =0.7)
    hol1.addSampleSlotPosition( Sample('Sample_O6', **md),6, 96,'WAXS', incident_angles=[0.05, 0.08, 0.1, 0.12, 0.15], thickness =0.7)

    hol2 = GIBar_Custom(base=stg)
    hol2.addGaragePosition(1,2)
    hol2.name = 'hol2'
    hol2.addSampleSlotPosition( Sample('Sample_R1', **md),1, 11,'WAXS', incident_angles=[0.08, 0.1, 0.12, 0.14, 0.16, 0.18, 0.2], thickness =0.7)
